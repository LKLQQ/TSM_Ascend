...
| 上传日期              | 2021-12-01                                 | 
| MindSpore版本          | 1.3.0                                                       |
| 数据集                    | SomethingSometing-v2                                     |
| 训练参数        | epoch=50, steps=2639, batch_size = 64, lr=0.1              | 
| 优化器                  | SGD                                                    | 
| 损失函数              | CrossEntropySmooth                                       |
| 输出                    | 概率                                                 | 
| 损失                       | 0.9808                                                    | 
| 速度                      | 单卡：963.812毫秒/步;  8卡：832.684毫秒/步                          | 
| 总时长                 | 单卡：/;  8卡：31h18min4s                        | 
| 微调检查点 | 275.85M (.ckpt文件)                                         |
| 推理模型        |  96.99M(.air文件)                     |
| 脚本                    | [TSM脚本](https://gitee.com/li-jianwei123/models) | 
...
| 上传日期       | 2021-12-01 |
| MindSpore 版本   | 1.3.0                       |
| 数据集             | SomethingSometing-v2, 24777段视频     |
| batch_size          | 64                         |
| 输出             | 概率                 |
| 准确性            | 单卡: /;  8卡：58.65%   | 
| 推理模型 | 161.76M (.om文件)         |
